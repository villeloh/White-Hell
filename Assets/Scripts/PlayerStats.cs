...
public class PlayerStats : MonoBehaviour
{
    ...
    // As typically only a small number of items will be created at once, imo it's not worth it to give a 'number' parameter to the constructor. 
    ...
    // Property for accessing 'playerName' from outside the class.
